...
/**
 * @Title: HoloCircularProgressBar
 * @Description: 描述
 * @date 2017/1/11 15:55
 * @auther xie
 */
public class HoloCircularProgressBar extends View {
    ...
    private TextPaint mMarkerTextPaint;
    ...
    private int mMarkerProgressColor;
    ...
    private Paint mThumbBitmapPaint;
    private int mThumbStrokeColor;
    private String mThumbStrokeText;
    private float mThumbStrokeTextSize;
    /**
     * The Thumb pos x.
     * <p>
    ...
    private String mMarkerProgressText;
    private float mMarkerProgressTextSize;
    private int mMarkerStrokeMove;
    private int mThumbStrokeMove;
            ...
            try {
                ...
                setMarkerProgress(
                        attributes.getFloat(R.styleable.HoloCircularProgressBar_marker_progress,
                                0.0f));
                setMarkerProgressText(attributes.getString(R.styleable.HoloCircularProgressBar_marker_progress_text));
                setMarkerProgressTextSize(attributes.getDimension(R.styleable.HoloCircularProgressBar_marker_progress_textSize, 12));
                setMarkerProgressColor(attributes.getColor(R.styleable.HoloCircularProgressBar_marker_progress_color, Color.GRAY));
                ...
                setThumbStrokeColor(attributes.getColor(R.styleable.HoloCircularProgressBar_thumb_stroke_color, Color.GRAY));
                setThumbStrokeText(attributes.getString(R.styleable.HoloCircularProgressBar_thumb_stroke_text));
                setThumbStrokeTextSize(attributes.getDimension(R.styleable.HoloCircularProgressBar_thumb_stroke_textSize, 16));
                mGravity = attributes
                        .getInt(R.styleable.HoloCircularProgressBar_android_gravity,
                                Gravity.CENTER);
//                bitmap = ((BitmapDrawable) getResources().getDrawable(R.drawable.big_circle)).getBitmap();
            } finally {
    ...
    private void setThumbStrokeTextSize(float dimension) {
        mThumbStrokeTextSize = dimension;
    }

    public void setThumbStrokeText(String string) {
        if (!TextUtils.isEmpty(string)) {
            mThumbStrokeText = string;
        } else {
            mThumbStrokeText = "";
        }
    }
    ...
    private void setMarkerProgressTextSize(float dimension) {
        mMarkerProgressTextSize = dimension;
    }

    public void setMarkerProgressText(String string) {
        if (!TextUtils.isEmpty(string)) {
            mMarkerProgressText = string;
        } else {
            mMarkerProgressText = "";
        }
    }
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (mIsMarkerEnabled) {
            ...
            if (markerRotation < 180) {
                canvas.rotate(0, mThumbPosX, mThumbPosY);
                mMarkerStrokeMove = -mCircleStrokeWidth;
            } else {
                canvas.rotate(180, mThumbPosX, mThumbPosY);
                mMarkerStrokeMove = +mCircleStrokeWidth;
            }
...
//                    (float) (mThumbPosX - mThumbRadius / 2 * 1.4), mThumbPosY, mMarkerColorPaint);
            mMarkerColorPaint.setColor(mMarkerProgressColor);
            canvas.drawCircle(mThumbPosX, mThumbPosY, (float) mCircleStrokeWidth, mMarkerColorPaint);
            canvas.drawText(mMarkerProgressText, mThumbPosX + mMarkerStrokeMove * 3.5f, mThumbPosY, mMarkerTextPaint);
            canvas.restore();
        }
        ...
        if (isThumbEnabled()) {
            ...
            if (progressRotation < 180) {
                // rotate the square by 45 degrees
                canvas.rotate(90 - progressRotation, mThumbPosX, mThumbPosY);
                mThumbStrokeTextSize = -mCircleStrokeWidth;
            } else {
                // rotate the square by 45 degrees
                canvas.rotate(90 + 360 - progressRotation, mThumbPosX, mThumbPosY);
                mThumbStrokeTextSize = +mCircleStrokeWidth;
            }
...
//            canvas.drawRect(mSquareRect, mThumbColorPaint);
            canvas.drawCircle(mThumbPosX, mThumbPosY, (float) mCircleStrokeWidth * 2.5f, mThumbColorPaint);
            canvas.drawCircle(mThumbPosX, mThumbPosY, (float) mCircleStrokeWidth * 2.5f, mThumbCirclePaint);
            canvas.drawText(mThumbStrokeText, mThumbPosX - mThumbStrokeTextSize * 8f, mThumbPosY + mCircleStrokeWidth * 2, mThumbTextPaint);
//            canvas.drawBitmap(bitmap, mThumbPosX - 60, mThumbPosY - 60, mThumbBitmapPaint);
            canvas.restore();
        }
    }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        mRadius = halfWidth - drawedWith - DensityUtils.dp2px(getContext(), 35);
        ...
        mTranslationOffsetY = halfWidth - DensityUtils.dp2px(getContext(), 25);
    ...
    private void setMarkerProgressColor(int color) {
        mMarkerProgressColor = color;
        updateMarkerColor();
    }
...
//        mMarkerColorPaint.setStrokeWidth(mCircleStrokeWidth / 2);
        ...
        mMarkerTextPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
        mMarkerTextPaint.setColor(mMarkerProgressColor);
        mMarkerTextPaint.setTextSize(mMarkerProgressTextSize);
    ...
    private void updateProgressColor() {
        ...
        mThumbColorPaint.setStyle(Paint.Style.FILL);
        mThumbColorPaint.setStrokeWidth(mCircleStrokeWidth);


        mThumbCirclePaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mThumbCirclePaint.setColor(mThumbStrokeColor);
        mThumbCirclePaint.setStyle(Paint.Style.STROKE);
        mThumbCirclePaint.setStrokeWidth(mCircleStrokeWidth);

        mThumbTextPaint = new TextPaint(Paint.ANTI_ALIAS_FLAG);
        mThumbTextPaint.setColor(mProgressColor);
        mThumbTextPaint.setTextSize(mThumbStrokeTextSize);
        mThumbTextPaint.setTextAlign(Paint.Align.CENTER);

//        mThumbBitmapPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
//        mThumbBitmapPaint.setFilterBitmap(true);
//        mThumbBitmapPaint.setDither(true);
